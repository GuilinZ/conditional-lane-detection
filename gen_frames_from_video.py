...
# fp = open('./datasets/video_frames/list/test.txt','w')
...
for i in range(num_frames):
    ...
    if frame is not None:
        cv2.imwrite('./datasets/video_frames/data/{}.png'.format(i),frame)
        fp.write('/data/{}.png\n'.format(i))
        fi = open('./datasets/video_frames/data/{}.lines.txt'.format(i), 'w')
        fi.close()
